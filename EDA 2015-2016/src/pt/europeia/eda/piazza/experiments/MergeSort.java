...
import static pt.europeia.eda.piazza.experiments.Utilities.isIncreasing;
import static pt.europeia.eda.piazza.experiments.Utilities.isLess;
...
public final class MergeSort {
    ...
    private static <Item extends Comparable<? super Item>> void sort(
        ...
        if (!isLess(source[middle + 1], source[middle])) {
            System.arraycopy(source, first, destination, first,
                    last - first + 1);
    ...
    private static <Item extends Comparable<? super Item>> void merge(
        ...
        assert isIncreasing(source, first,
                middle) : "Can only merge increasing segments.";
        assert isIncreasing(source, middle + 1,
        ...
        assert isIncreasing(destination, first,
