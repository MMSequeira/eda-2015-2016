package pt.europeia.eda.book.chapter2.section3;
...
public final class OptimizedQuick {
    ...
    private static <Item extends Comparable<? super Item>> void sort(
        ...
        final int positionOfMedian = positionOfMedianOf3(values, first, middle,
                last);
        swap(values, first, positionOfMedian);
    ...
    public static void main(final String[] arguments) {
        ...
        for (int i = 0; i != words.length; i++) {
            final String ith = OptimizedQuick.select(words, i);
            StdOut.println(ith);
        }
    }
